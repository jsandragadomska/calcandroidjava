...
public class Hexadecimal extends AppCompatActivity {
    ...
    private void onClickList(){
        ...
        butA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                typing.setText(typing.getText().toString()+"A");
            }
        });
        butB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                typing.setText(typing.getText().toString()+"B");
            }
        });
        butC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                typing.setText(typing.getText().toString()+"C");
            }
        });
        butD.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                typing.setText(typing.getText().toString()+"D");
            }
        });
        butE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                typing.setText(typing.getText().toString()+"E");
            }
        });
        butF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                typing.setText(typing.getText().toString()+"F");
            }
        });
    }
